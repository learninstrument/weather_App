...
const server = http.createServer(async(req, res) => {
  ...
  async function handedWeatherRequest(req, res, query) {
      ...
      try{
        ...
        console.log('weather API not found')
        ...
        apiRes.on('end',()=> {
          ...
          if(weatherData.cod !== 200){
            if(weatherData.cod == 400){
                ...
                reject('API error' + weatherData.message)
            }
          ...
          const formattedData = {
              ...
              pressure: weatherData.main.pressure, // Air pressure
          ...
          resolve(formattedData)
            ...
            reject( new Error('failed to parsed data'))
          }
        })
